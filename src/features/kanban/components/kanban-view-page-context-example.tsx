...
import { useShareRetroDialog } from '@/components/modal/share-retro-dialog-context';
...
export default function KanbanViewPage({ retroId }: { retroId: string }) {
  ...
  const { openShareDialog } = useShareRetroDialog();
  ...
  return (
    <div className='relative flex h-full flex-col'>
      ...
      {/* Header Section */}
      <HeaderBar onShareClick={() => openShareDialog(retroId)} />
...
export function HeaderBar({ onShareClick }: { onShareClick: () => void }) {
